...
interface CoreRepositoryInterface
{
    ...
    public function getAllWithPaginate(int|null $perPage, int $page, string $orderBy, string $orderWay, bool $useCache = true, array $filterFieldsData = []): LengthAwarePaginator;
