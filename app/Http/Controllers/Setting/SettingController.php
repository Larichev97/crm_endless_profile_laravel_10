...
class SettingController extends Controller
{
    ...
    public function store(SettingStoreRequest $settingStoreRequest): RedirectResponse|JsonResponse
    {
        try {
            ...
            if ($createSetting) {
                return redirect()->route('settings.index')->with('success','Настройка успешно создана.');
            }
    ...
    public function update(SettingUpdateRequest $settingUpdateRequest, $id): RedirectResponse|JsonResponse
    {
        try {
            ...
            if ($updateSetting) {
                return redirect()->route('settings.index')->with('success', sprintf('Данные настройки #%s успешно обновлены.', $id));
            }
    ...
    public function destroy($id): RedirectResponse|JsonResponse
    {
        try {
            ...
            if ($deleteSetting) {
                return redirect()->route('settings.index')->with('success', sprintf('Настройка #%s успешно удалена.', $id));
            }
