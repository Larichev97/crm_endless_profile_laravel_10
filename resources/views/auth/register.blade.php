            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Добро пожаловать!</h1>
                        <p class="text-lead text-white">Введите заполните форму регистрации, чтобы создать учётную запись.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="form-check form-check-info text-start">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Я согласен с <a href="javascript:;" class="text-dark font-weight-bolder">Условиями использования</a>
                                    </label>
