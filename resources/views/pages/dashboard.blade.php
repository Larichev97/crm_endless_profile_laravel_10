                    ...
                    <div class="card bg-gradient-info">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Заявок</p>
                                        <h5 class="font-weight-bolder">@if(isset($contactFormsTotalCount)){{ $contactFormsTotalCount }}@else 0 @endif</h5>
                                    </div>
                                </div>
                    ...
                    <div class="card bg-gradient-success">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">Клиентов</p>
                                        <h5 class="font-weight-bolder">@if(isset($clientsTotalCount)){{ $clientsTotalCount }}@else 0 @endif</h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                    <div class="icon icon-shape bg-gradient-dark shadow-primary text-center rounded-circle">
                    ...
                    <div class="card bg-gradient-warning">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">QR-прифилей</p>
                                        <h5 class="font-weight-bolder">@if(isset($qrProfilesTotalCount)){{ $qrProfilesTotalCount }}@else 0 @endif</h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                    <div class="icon icon-shape bg-gradient-dark shadow-danger text-center rounded-circle">
                                        <i class="fa fa-qrcode text-lg opacity-10" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
