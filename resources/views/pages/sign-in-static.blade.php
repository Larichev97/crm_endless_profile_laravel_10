                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    <form role="form">
                                        ...
                                        <div class="text-center">
                                            <button type="button" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Войти</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-sm mx-auto">
                                        ...
                                        <a href="javascript:;" class="text-primary text-gradient font-weight-bold">Зарегистрироваться</a>
                                    </p>
                                </div>
                            </div>
                        </div>
