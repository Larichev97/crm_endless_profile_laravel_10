...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Мой профиль'])
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            Developer {{-- Выводить роль пользователя или ещё что-то.... --}}
                        </p>
                    </div>
                </div>
                        ...
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center justify-content-center "
                                    ...
                                    <span class="ms-2">Настройки</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <form role="form" method="POST" action={{ route('admin.profile.update') }} enctype="multipart/form-data">
                        ...
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Редактирование профиля</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Псевдоним</label>
                            ...
                            <p class="text-uppercase text-sm">Контектная информация</p>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Почтовый индекс</label>
                                        <input class="form-control" type="text" name="postal" value="{{ old('postal', auth()->user()->postal) }}">
                                    </div>
                                </div>
                            </div>
                            <hr class="horizontal dark">
                            <p class="text-uppercase text-sm">Обо мне</p>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Обо мне</label>
