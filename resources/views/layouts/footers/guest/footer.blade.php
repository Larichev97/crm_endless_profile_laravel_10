    ...
    <div class="container-fluid">
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-12 mb-lg-0 mb-4 mt-4 text-center">
                <button type="button" class="btn btn-block mb-3 btn-lg btn-dark text-uppercase" data-bs-toggle="modal" data-bs-target="#contact_form_modal">Замовити QR-профіль</button>
            </div>
