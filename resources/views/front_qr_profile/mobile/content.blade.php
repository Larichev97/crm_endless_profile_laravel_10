                    ...
                    @if(!empty($qrProfile->favourite_music_artist))
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <div class="mb-4 p-3 border bg-light" style="border-radius: 1rem!important;">
                                    <a href="https://music.youtube.com/search?q={{ $qrProfile->favourite_music_artist }}" class="text-dark" target="_blank">{{ $qrProfile->favourite_music_artist }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <div class="mb-4" style="border-radius: 1rem!important;">
                                    @include('components.slider', ['galleryData' => $sliderGalleryImagesData, 'idGallery' => 'qrProfileGallery', 'imageHeight' => 300])
                                </div>
                            </div>
                        </div>
                    @endif
